...
<body>
  ...
  <body id="body-pd">
    <header class="header" id="header">
      ...
      <div class="header_img"> <img src='displayorglogo?id=${id}'> </div>
    </header>
    <div class="l-navbar" id="nav-bar">
      <nav class="nav">
        <div> 
          <a href="orghome" class="nav_logo"> <i class='bx bx-layer nav_logo-icon'></i>
             <span class="nav_logo-name">Hi, ${orgname}</span> 
          </a>
           ...
           <div class="dropdown">
            ...
            <i class='bx bx-user nav_icon'></i>
             ...
             <ul class="dropdown-menu">
               ...
               <li><a class="dropdown-item" href="deleteuser">Delete Member</a></li>
               <li><a class="dropdown-item" href="viewallmembers">View All Members</a></li>
             </ul>
           </div>
            ...
            <div class="dropdown">
                 ...
                 <i class='bx bx-bookmark nav_icon'></i>
                  ...
                  <ul class="dropdown-menu">
                    <li><a class="dropdown-item" href="pollcreation">Add a Poll</a></li>
        ...
        <a href="orglogin" class="nav_link"> 
